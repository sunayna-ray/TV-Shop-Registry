...
echo "<br/>
<br/>
<table border = 1 align=Center><CAPTION>SALES DETAILS</CAPTION>
<tr>
<th>Sr.No.</th>
<th>Date</th>
<th>Bill Number</th>
...
while($record=mysql_fetch_array($data)){
	...
	echo "<td>".$record["Date"];
	echo "<td>".$record["Bill Number"];
	echo "<td>".$record["Product Code"];
	echo "<td>".$record["Costumer Code"];
	echo "<td>".$record["Quantity"];
	echo "<td>".$record["Total Cost"];
